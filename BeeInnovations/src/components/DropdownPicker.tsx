...
import { ArrowDown, ArrowDown2, ArrowDown3, CloseCircle, Health, PenClose, SearchNormal1, TickCircle } from 'iconsax-react-native';
...
const DropdownPicker = (props: Props) => {
    ...
    const [results, setResutls] = useState<SelectModel[]>([]);
                    ...
                    <FlatList
                        ...
                        renderItem={({ item }) => (
                            <RowComponent
                                ...
                                key={item.value} styles={{ paddingVertical: 16 }}>
